...
const Quiz = () => {
    ...
    // for answering again in any question (if user's doesn't came back to give the answer the review answer will be counted as given answer)
    const review = ()=>{
      if(index==0){
   ...
   <div className='main'>
    <div className='container'>
     {!result? <><h1>Quiz App</h1> <hr/></>: <></>}
      ...
      <div className='myText'>{index+1} out of {data.length} questions </div>
      <Webcam style={{
